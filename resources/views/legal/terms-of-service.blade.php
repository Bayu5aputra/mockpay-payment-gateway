            ...
            <main class="flex-1 max-w-4xl">
                ...
                <div class="prose prose-lg max-w-none">
                    ...
                    <section id="contact" class="mb-12">
                        <h2 class="text-3xl font-bold text-gray-900 mb-5 tracking-tight">Contact Information</h2>
                        <p class="text-gray-700 leading-relaxed text-base mb-6 text-justify">
                            If you have any questions about these Terms of Service or need assistance with your account, please contact us through our official channels. Our support team is available to help you with service-related inquiries during business hours.
                        </p>
                        <div class="bg-white border-2 border-gray-200 rounded-xl p-8">
                            <div class="space-y-6">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-gray-500 uppercase tracking-wider mb-1">Legal Inquiries</p>
                                        <p class="text-lg font-semibold text-gray-900">legal@mockpay.com</p>
                                        <p class="text-sm text-gray-600 mt-1">For legal matters and Terms of Service questions only</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-gray-500 uppercase tracking-wider mb-1">Mailing Address</p>
                                        <p class="text-lg font-semibold text-gray-900">Jl. Sudirman No. 123<br>Jakarta Pusat 10220<br>Indonesia</p>
                                        <p class="text-sm text-gray-600 mt-1">For formal legal correspondence only</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-gray-500 uppercase tracking-wider mb-1">Business Hours</p>
                                        <p class="text-lg font-semibold text-gray-900">+62 21 1234 5678</p>
                                        <p class="text-sm text-gray-600 mt-1">Monday - Friday, 9:00 AM - 5:00 PM WIB</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
                            <p class="text-sm text-gray-600 text-center">
                                <strong>Final Acknowledgement:</strong> By using MockPay's services, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service. These Terms constitute the entire agreement between you and MockPay regarding the service and supersede all prior agreements and understandings. If any provision of these Terms is found to be unenforceable, the remaining provisions will remain in full force and effect.
                            </p>
                        </div>
                    </section>
                </div>
