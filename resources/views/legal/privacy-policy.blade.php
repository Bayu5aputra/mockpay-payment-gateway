                ...
                <div class="prose prose-lg max-w-none">
                    ...
                    <section id="introduction" class="mb-12">
                        ...
                        <div class="bg-blue-50 border-l-4 border-blue-500 p-5 rounded-r-lg">
                            <p class="text-gray-800 text-base font-semibold mb-2">⚠️ Important Notice</p>
                            <p class="text-gray-700 text-sm leading-relaxed">
                                MockPay is a <strong>sandbox payment gateway for testing purposes only</strong>. No real money is processed through this system. All transactions are simulated for development and testing environments.
                            </p>
                        </div>
                    </section>
                    ...
                    <section id="information-we-collect" class="mb-12">
                        ...
                        <div class="space-y-4">
                            <div class="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-purple-300 transition-colors duration-200">
                                ...
                                <p class="text-gray-700 text-base leading-relaxed">Name, email address, company name, and password for account creation and authentication.</p>
                            </div>

                            <div class="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-purple-300 transition-colors duration-200">
                                <h3 class="text-xl font-bold text-gray-900 mb-3">API Credentials</h3>
                                <p class="text-gray-700 text-base leading-relaxed">Merchant ID, API keys, and webhook URLs for testing integration with your applications.</p>
                            </div>

                            <div class="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-purple-300 transition-colors duration-200">
                                <h3 class="text-xl font-bold text-gray-900 mb-3">Test Transaction Data</h3>
                                <p class="text-gray-700 text-base leading-relaxed">Simulated payment information including dummy card numbers, virtual account details, and transaction amounts used for testing.</p>
                            </div>

                            <div class="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-purple-300 transition-colors duration-200">
                                <h3 class="text-xl font-bold text-gray-900 mb-3">Usage Data</h3>
                                <p class="text-gray-700 text-base leading-relaxed">Information about how you interact with our service, including API calls, dashboard usage, and feature utilization.</p>
                            </div>

                            <div class="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-purple-300 transition-colors duration-200">
                                <h3 class="text-xl font-bold text-gray-900 mb-3">Technical Information</h3>
                                <p class="text-gray-700 text-base leading-relaxed">IP address, browser type, device information, and operating system for security and service improvement.</p>
                            </div>
                        </div>
                    </section>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-700 text-base leading-relaxed">To provide access to our dummy payment gateway and simulate payment processing for your testing needs.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-700 text-base leading-relaxed">To create and manage your account, authenticate users, and provide customer support.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-700 text-base leading-relaxed">To analyze usage patterns and improve our testing platform's features and performance.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-700 text-base leading-relaxed">To protect against unauthorized access, abuse, and ensure the security of our testing environment.</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-gray-700 text-base leading-relaxed">To send you important updates, technical notices, and respond to your inquiries.</p>
                                </div>
                            </div>
                        </div>
                    </section>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-700">All data transmission is encrypted using industry-standard protocols.</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-700">Data is stored in secure databases with restricted access controls.</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-700">API keys are encrypted and can be regenerated at any time.</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-700">Continuous monitoring for suspicious activities and security threats.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <section id="your-rights" class="mb-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div class="bg-white border-2 border-gray-200 rounded-xl p-6">
                                ...
                                <p class="text-gray-700 text-base">Request a copy of your personal information stored in our system.</p>
                            </div>
                            ...
                            <div class="bg-white border-2 border-gray-200 rounded-xl p-6">
                                ...
                                <p class="text-gray-700 text-base">Update or correct any inaccurate or incomplete information.</p>
                            </div>
                            ...
                            <div class="bg-white border-2 border-gray-200 rounded-xl p-6">
                                ...
                                <p class="text-gray-700 text-base">Request deletion of your account and associated data.</p>
                            </div>
                            ...
                            <div class="bg-white border-2 border-gray-200 rounded-xl p-6">
                                ...
                                <p class="text-gray-700 text-base">Download your data in a portable format.</p>
                            </div>
                        </div>
                    </section>
                        ...
                        <div class="bg-white border-2 border-gray-200 rounded-xl p-8">
                            <div class="space-y-6">
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-gray-500 uppercase tracking-wider mb-1">Website</p>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <p class="text-sm font-bold text-gray-500 uppercase tracking-wider mb-1">Support</p>
