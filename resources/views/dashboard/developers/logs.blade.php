<x-app-layout>
    <div class="min-h-screen bg-[#eae6df] py-10">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">Monitor pengiriman webhook untuk transaksi Anda.</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md p-6 mb-6">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="event" value="{{ request('event') }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent" placeholder="payment.success">
                </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-6 py-6 text-center text-gray-500">Belum ada webhook logs.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
