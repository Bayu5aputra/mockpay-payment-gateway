        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="{{ route('docs.index') }}" class="text-sm hover:text-white transition-colors">Documentation</a></li>
                        <li><a href="{{ route('pricing') }}" class="text-sm hover:text-white transition-colors">Pricing</a></li>
